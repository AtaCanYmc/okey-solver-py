...
def test_vision_solver_engine_orchestration():
    ...
    def detect_fn(frame):
        calls.append('detect')
        return [
            Detection(id='d1', bounds=BoundingBox(x=0, y=0, width=10, height=10), confidence=0.98, label='RED-5'),
            Detection(id='d2', bounds=BoundingBox(x=12, y=0, width=10, height=10), confidence=0.98, label='RED-6'),
            Detection(id='d3', bounds=BoundingBox(x=24, y=0, width=10, height=10), confidence=0.98, label='RED-7'),
        ]
