...
class OkeyRuleValidator:
    ...
    def is_tiles_same(
        self, tile_a: Tile, tile_b: Tile, okey_meta: Optional[OkeyMeta] = None
    ) -> bool:
    ...
    def get_effective_tile(
        self, tile: Tile, okey_meta: Optional[OkeyMeta] = None
    ) -> Tile:
        if not okey_meta:
            return tile
...
class RuleValidator:
    ...
    @classmethod
    def is_tiles_same(
        cls, tile_a: Tile, tile_b: Tile, okey_meta: Optional[OkeyMeta] = None
    ) -> bool:
        return cls._validator.is_tiles_same(tile_a, tile_b, okey_meta)

    @classmethod
    def get_effective_tile(
        cls, tile: Tile, okey_meta: Optional[OkeyMeta] = None
    ) -> Tile:
