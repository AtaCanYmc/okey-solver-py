...
class SolverEngine:
    ...
    def find_best_arrangement(self, tiles: List[Tile], okey_meta: Optional[OkeyMeta] = None) -> Arrangement:
    ...
    @classmethod
    def findBestArrangement(cls, tiles: List[Tile], okey_meta: Optional[OkeyMeta] = None) -> Arrangement:
        return cls.get_default_engine().find_best_arrangement(tiles, okey_meta)

    @classmethod
    def findBestPairs(cls, tiles: List[Tile], okey_meta: Optional[OkeyMeta] = None) -> Dict[str, Any]:
